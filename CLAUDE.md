...
3. `READ gitnexus://repo/genguard/process/{processName}` — trace the full execution flow step by step
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/genguard/context` | Codebase overview, check index freshness |
| `gitnexus://repo/genguard/clusters` | All functional areas |
| `gitnexus://repo/genguard/processes` | All execution flows |
| `gitnexus://repo/genguard/process/{name}` | Step-by-step execution trace |
